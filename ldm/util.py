...
UNET_EXTENDED_TARGET_REPLACE = {"ResBlock"}
...
#         lora_diffusion.LoraInjectedLinear,
#         lora_diffusion.LoraInjectedConv2d,
#     ],
# ):
#     """
...
# def my_inject_trainable_lora_extended(
...
#         model, target_replace_module, search_class=[torch.nn.Linear, torch.nn.Conv2d]
#     ):
#         if _child_module.__class__ == torch.nn.Linear:
#             weight = _child_module.weight
#             bias = _child_module.bias
#             _tmp = lora_diffusion.LoraInjectedLinear(
...
#             weight = _child_module.weight
#             bias = _child_module.bias
#             _tmp = lora_diffusion.LoraInjectedConv2d(
